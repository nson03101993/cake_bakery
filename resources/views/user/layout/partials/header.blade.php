        ...
        <div class="main_menu_area">
            <div class="container">
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <img src="{{ asset('public/frontend/img/logo-2.png') }}" alt="">
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto">
                            <li class="dropdown active">
                                <a class="dropdown-toggle" data-toggle="dropdown" href="{{ route('home.page') }}" role="button" aria-haspopup="true" aria-expanded="false">Trang Chủ</a>
                            </li>
